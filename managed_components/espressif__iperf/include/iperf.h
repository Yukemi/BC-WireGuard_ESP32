...
/* Adjusted to run for the whole cycle*/
#define IPERF_SOCKET_RX_TIMEOUT CONFIG_IPERF_TIME + CONFIG_IPERF_LOOP_RESET_ADD
#define IPERF_SOCKET_TCP_TX_TIMEOUT CONFIG_IPERF_TIME + CONFIG_IPERF_LOOP_RESET_ADD
